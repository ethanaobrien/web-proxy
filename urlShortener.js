...
module.exports = async function(req, res) {
    ...
    if (req.url.toLowerCase() === '/tinyurl' && (errMsg && errMsg.trim() || (!args.url && !args.phrase))) {
        ...
        let html = '<html><head><title>Url Shortener</title><meta name="viewport" content="width=device-width, initial-scale=1"></head><body><ul><br><h1>Url Shortener</h1><ul>';
